...
class Pgraph():
    ...
    def create_solver_input(self, system=None, input_file=None):
        '''
        create_solver_input()
    ...
    def solve(self,system=None,skip_wine=False, solver_name='pgraph_solver.exe',path=None):
        ...
        if system=="Windows": #support for windows
            ...
            subprocess.run([path + solver_name,solver,input_file,output_file,str(max_sol)])

        ################
    
    def read_solutions(self,system=None, output_file=None):
        '''
        read_solutions()
